...
namespace lupnt {
    ...
    class DynamicsParamWithOption {
        ...
        public:
            ...
            DynamicsParamWithOption(DynamicsParam params) {
                ...
                std::cout << "[DynamicsParamWithOption] Parameters are set to TrueFixed by default" << std::endl;
            }
    ...
    class DynamicsWithParams : public IDynamics {
        ...
        public:
            ...
            DynamicsWithParams(Ptr<IDynamics> dyn, 
                               DynamicsParamWithOption params) {
                dynamics_ = dyn;
                use_params_ = true;
                params_ = params;
            }
            ...
            Ptr<IDynamics> GetDynamics() {
                return dynamics_;
            }

            DynamicsParam GetParams() {
                return params_.GetDynamicsParam();
            }
            ...
            */
            Ptr<IState> PropagateState(const Ptr<IState>& state, Real t0, Real tf, MatXd* stm = nullptr) override {
                // warning
                std::cout << "Warning: PropagateState does not consider parameters in stm when using DynamicsWithParams" << std::endl;
