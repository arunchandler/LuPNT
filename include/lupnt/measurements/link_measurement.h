...
namespace lupnt {
  ...
  public:
     ...
     *
     * @param epoch_local     (local) epoch of the receiver or transmitter when the signal is transmitted/received
     ...
     * @param H_ow_rx            Jacobian matrix
     * @param additional_delay   Additional delay for the rx time  (recorded = true + clk_bias + additional_delay)
     ...
     * @return VecX 
     */
    VecX GetOneWayLinkMeasurement(Real epoch_rx_recorded, Real epoch_ref, Vec6 rv_tx, Vec6 rv_rx, Vec2 clk_tx,
     ...
     * @return Real 
     */
    Real GetOneWayRangeMeasurement(Real epoch_rx_recorded, Real epoch_ref, Vec6 rv_tx, Vec6 rv_rx, Vec2 clk_tx, Vec2 clk_rx,
                                   MatXd &H_ow_rx, Real additional_delay, bool with_noise,
                                   bool with_jacobian);
     ...
     * @return Real 
     */
    Real GetOneWayRangeRateMeasurement(Real epoch_rx_recorded, Real epoch_ref, Vec6 rv_tx, Vec6 rv_rx, Vec2 clk_tx,
                                       Vec2 clk_rx, MatXd &H_ow_rx, Real additional_delay,
                                       bool with_noise, bool with_jacobian);
     ...
     * @return VecX 
     */
    VecX GetTwoWayLinkMeasurement(Real epoch_rx, Real epoch_ref, Vec6 rv_receiver, Vec6 rv_target, Vec2 clk_receiver, Vec2 clk_target,
     ...
     * @param clk_receiver    Receiver clock state at the ref epoch
     * @param clk_target      Transmitter clock state at the ref epoch
     * @param H_tw_range      Jacobian matrix
     * @param hardware_delay  Hardware delay at the target relay 
     * @param with_noise      (bool) add noise to the measurement
     * @param with_jacobian   (bool) compute jacobian
     * @return Real 
     */
    Real GetTwoWayRangeMeasurement(Real epoch_rx, Real epoch_ref, Vec6 rv_receiver, Vec6 rv_target, Vec2 clk_receiver, Vec2 clk_target,
     ...
     * @param clk_receiver    Receiver clock state at the ref epoch
     * @param clk_target      Transmitter clock state at the ref epoch
     * @param H_tw_rr         Jacobian matrix
     * @param hardware_delay  Hardware delay at the target relay 
     * @param with_noise      (bool) add noise to the measurement
     * @param with_jacobian   (bool) compute jacobian
     * @return Real 
     */
    Real GetTwoWayRangeRateMeasurement(Real epoch_rx, Real epoch_ref, Vec6 rv_receiver, Vec6 rv_target, Vec2 clk_receiver, Vec2 clk_target,
