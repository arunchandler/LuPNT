...
class IntegratorParams:
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, max_iter: int = ..., abstol: float = ..., reltol: float = ...) -> None: ...
...
@overload
def compute_occultation(epoch: float, r1: numpy.ndarray[numpy.float64[3, 1]], r2: numpy.ndarray[numpy.float64[3, 1]], cs1: Frame, cs2: Frame, bodies: list[NaifId], atm_h: numpy.ndarray[numpy.float64[m, 1]], min_elev: numpy.ndarray[numpy.float64[m, 1]], use_elev_mask1: bool = ..., use_elev_mask2: bool = ...) -> dict[str, bool]: ...
@overload
def compute_occultation(epoch: float, r1: numpy.ndarray[numpy.float64[m, 3]], r2: numpy.ndarray[numpy.float64[m, 3]], cs1: Frame, cs2: Frame, bodies: list[NaifId], atm_h: numpy.ndarray[numpy.float64[m, 1]], min_elev: numpy.ndarray[numpy.float64[m, 1]], use_elev_mask1: bool = ..., use_elev_mask2: bool = ...) -> list[dict[str, bool]]: ...
@overload
def compute_occultation(epoch: numpy.ndarray[numpy.float64[m, 1]], r1: numpy.ndarray[numpy.float64[m, 3]], r2: numpy.ndarray[numpy.float64[m, 3]], cs1: Frame, cs2: Frame, bodies: list[NaifId], atm_h: numpy.ndarray[numpy.float64[m, 1]], min_elev: numpy.ndarray[numpy.float64[m, 1]], use_elev_mask1: bool = ..., use_elev_mask2: bool = ...) -> list[dict[str, bool]]: ...
@overload
...
def get_lunar_orientation_angles(t_tai: float) -> numpy.ndarray[numpy.float64[6, 1]]: ...
@overload
