...
void init_time_converter(py::module &m) {
  ...
  m.DEF_REAL("utc2ut1", UTC2UT1, "t_utc");
  m.DEF_REAL("ut12utc", UT12UTC, "t_ut1");
  m.DEF_REAL("tai2utc", TAI2UTC, "t_tai");
  m.DEF_REAL("utc2tai", UTC2TAI, "t_utc");
  m.DEF_REAL("tai2tt", TAI2TT, "t_tai");
  m.DEF_REAL("tt2tai", TT2TAI, "t_tt");
  m.DEF_REAL("tcg2tt", TCG2TT, "t_tcg");
  m.DEF_REAL("tt2tcg", TT2TCG, "t_tt");
  m.DEF_REAL("tt2tdb", TT2TDB, "t_tt");
  m.DEF_REAL("tdb2tt", TDB2TT, "t_tdb");
  m.DEF_REAL("tai2gps", TAI2GPS, "t_tai");
