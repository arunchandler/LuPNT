...
namespace lupnt {
    ...
    SurfaceStaticDynamics::SurfaceStaticDynamics(const NaifId body_id, const Frame state_frame = Frame::NONE) : body_id_(body_id), state_frame_(state_frame) {
    ...
    OrbitState SurfaceStaticDynamics::PropagateState(const OrbitState &state, Real t0, Real tf, Mat6d *stm) {
